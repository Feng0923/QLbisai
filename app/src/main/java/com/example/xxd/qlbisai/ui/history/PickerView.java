...
public class PickerView extends ScrollView {
    ...
    public PickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTextHeight = (int) ((mDensity ) * mTextSize);
            ...
            mWrapContentHeight = mTextHeight * 2;
...
//        mTextGroup.addView(createTextView(""));
        ...
        if (tempPosition != position) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (position  == i) {
                    ...
                    Log.d("cao",(String)((TextView)mTextGroup.getChildAt(position)).getText());
    ...
    public String getContent(){
        TextView t = (TextView) mTextGroup.getChildAt(position);
